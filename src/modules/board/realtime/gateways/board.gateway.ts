    ...
    OnModuleDestroy
{
  ...
  constructor(
    ...
    private readonly relay: BroadcastRelayService,
  ) {}
   ...
   * Attaches the server to the broadcast relay and starts the periodic
   * stale-presence cleanup loop.
   */
  afterInit(): void {
    this.relay.attachServer(this.server);
