...
describe('BroadcastRelayService', () => {
  ...
  beforeEach(() => {
    ...
    relay.attachServer(mockServer as any);
  });
  ...
  afterEach(() => {
    ...
    it('should gracefully drop events when server is not attached across all broadcaster methods', () => {
      ...
      expect(() => {
        relay.broadcastBoardCreated(new BoardCreatedEvent({ workspaceId: 'ws-1' } as any, 'u-1'));
        relay.broadcastBoardUpdated(new BoardUpdatedEvent({ id: 'b-1' } as any, 'u-1'));
        relay.broadcastBoardArchived(new BoardArchivedEvent('b-1', 'ws-1', 'u-1'));
        relay.broadcastBoardUnarchived(new BoardUnarchivedEvent({ id: 'b-1' } as any, 'u-1'));
        relay.broadcastListCreated(new ListCreatedEvent({ boardId: 'b-1' } as any, 'u-1'));
        relay.broadcastListUpdated(new ListUpdatedEvent({ id: 'l-1', boardId: 'b-1' } as any, 'u-1'));
        ...
        relay.broadcastListUnarchived(new ListUnarchivedEvent({ id: 'l-1', boardId: 'b-1' } as any, 'u-1'));
        relay.broadcastCardCreated(new CardCreatedEvent({} as any, 'b-1', 'l-1', 'u-1'));
        relay.broadcastCardUpdated(new CardUpdatedEvent({ id: 'c-1' } as any, 'b-1', 'u-1'));
        relay.broadcastCardMoved(new CardMovedEvent('c-1', 'b-1', 'l-1', 'l-2', 'r', 'u-1'));
        relay.broadcastCardArchived(new CardArchivedEvent('c-1', 'b-1', 'l-1', 'u-1'));
        relay.broadcastCardUnarchived(new CardUnarchivedEvent({ id: 'c-1' } as any, 'b-1', 'l-1', 'u-1'));
        relay.broadcastCommentCreated(new CommentCreatedEvent({} as any, 'b-1', 'u-1'));
        relay.broadcastAttachmentCreated(new AttachmentCreatedEvent({} as any, 'b-1', 'u-1'));
        relay.broadcastAttachmentDeleted(new AttachmentDeletedEvent('att-1', 'c-1', 'b-1', 'u-1'));
        relay.broadcastChecklistCreated(new ChecklistCreatedEvent({} as any, 'b-1', 'u-1'));
        relay.broadcastChecklistUpdated(new ChecklistUpdatedEvent('cl-1', 'c-1', 'b-1', 'u-1'));
        relay.broadcastChecklistDeleted(new ChecklistDeletedEvent('cl-1', 'c-1', 'b-1', 'u-1'));
      }).not.toThrow();
    });
  });
