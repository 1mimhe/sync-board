  ...
  return (
    <div
      ...
      style={{
        ...
        position: 'relative',
        background:
          'radial-gradient(1000px 600px at 20% -10%, rgba(124, 58, 237, 0.25), transparent 60%), radial-gradient(800px 500px at 80% 100%, rgba(6, 182, 212, 0.15), transparent 60%), var(--bg)',
      }}
    >
      <div
      ...
      >
        ...
        <div style={{ display: 'grid', gap: 8, textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 13.5 }}>
            Real-time collaborative workspaces, boards & docs.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: 14 }}>
          ...
          <label style={{ display: 'grid', gap: 6, fontSize: 13, fontWeight: 700, color: 'var(--muted)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Password</span>
              <Link to="/forgot-password" style={{ color: 'var(--violet2)', fontWeight: 600, fontSize: 12 }}>
                Forgot?
              </Link>
            </div>
        ...
        <div style={{ textAlign: 'center', fontSize: 13, color: 'var(--muted)' }}>
          ...
          <Link to={`/register${redirectUrl !== '/workspaces' ? `?redirect=${encodeURIComponent(redirectUrl)}` : ''}`} style={{ color: 'var(--violet2)', fontWeight: 700 }}>
            Create one
          </Link>
        </div>
      </div>
